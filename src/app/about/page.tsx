      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <div className="max-w-3xl mx-auto mt-6 text-foreground/80">
              <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-center max-w-4xl mx-auto">
            <Card className="bg-card border-border/50">
              <CardHeader>
                ...
                <CardTitle className="mt-4 text-2xl font-headline">Misión</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-card border-border/50">
              <CardHeader>
                ...
                <CardTitle className="mt-4 text-2xl font-headline">Visión</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-foreground/90">
