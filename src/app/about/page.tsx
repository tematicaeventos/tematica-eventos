    ...
    <div className="animate-fade-in-up">
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl font-bold font-headline text-primary mt-8">
              20 Años Creando Momentos Inolvidables
            </h2>
            <div className="max-w-3xl mx-auto mt-6 text-primary">
              <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-center max-w-4xl mx-auto">
            <Card className="bg-card border-border/50">
              <CardHeader>
                ...
                <CardTitle className="mt-4 text-2xl font-headline text-primary">Misión</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-card border-border/50">
              <CardHeader>
                ...
                <CardTitle className="mt-4 text-2xl font-headline text-primary">Visión</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-primary">
      ...
      <section className="py-16 md:py-24 bg-card border-y border-border">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold font-headline text-primary mt-4">
            Nuestros Datos
          </h2>
          ...
          <div className="mt-8 space-y-4 max-w-md mx-auto text-left">
              <div className="flex items-center gap-4 p-4 bg-background rounded-lg border">
                  ...
                  <p className="text-primary">hernan.ramirez@tematicaeventos.com (ejemplo)</p>
              </div>
               <div className="flex items-center gap-4 p-4 bg-background rounded-lg border">
                  <Phone className="h-5 w-5 text-primary" />
                  <p className="text-primary">3045295251</p>
              </div>
               <div className="flex items-center gap-4 p-4 bg-background rounded-lg border">
                  <MapPin className="h-5 w-5 text-primary" />
                  <p className="text-primary">Calle 18 # 5-17, Soacha, Cundinamarca</p>
              </div>
          </div>
          <p className="mt-8 text-primary">Hernan Ramirez Sanchez - Gerente General</p>
        </div>
      </section>
    </div>
  );
